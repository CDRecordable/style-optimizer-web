...
// DICCIONARIO DE INCONTABLES (Expandido)
export const UNCOUNTABLES = new Set([
    "mucho", "mucha", "muchos", "muchas",
    "poco", "poca", "pocos", "pocas",
    "bastante", "bastantes",
    "demasiado", "demasiada", "demasiados", "demasiadas",
    "varios", "varias", "múltiples", "numerosos", "numerosas",
    "miles", "millones", "cientos", "millares",
    "infinidad", "montón", "mogollón", "cantidad", "multitud",
    "algunos", "algunas", "ciertos", "ciertas",
    "un sinfín", "una barbaridad", "la mayoría", "gran parte",
    "todo", "toda", "todos", "todas", "nada", "algo"
]);

// VERBOS BAÚL (Expandido con burocráticos)
...
export const SUSTANTIVOS_BAUL = new Set([
  ...
  "manera", "formas", "modo", "estilo",
  "bueno", "malo", "importante", "interesante", 
  "aspecto", "elemento", "factor", "cuestión", "dato", "hecho",
  "situación", "circunstancia", "momento"
]);

export const PALABRAS_BAUL = new Set([...VERBOS_BAUL, ...SUSTANTIVOS_BAUL]);

// VERBOS DE PERCEPCIÓN (Filtros Mentales)
...
// DICCIONARIO SENSORIAL (Muy expandido)
